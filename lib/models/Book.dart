...
class Book extends Model {
  ...
  const Book._internal({required this.id, required title, author, publisher, createdAt, updatedAt}): _title = title, _author = author, _publisher = publisher, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Book({String? id, required String title, String? author, String? publisher}) {
  ...
  Book copyWith({String? title, String? author, String? publisher}) {
    return Book._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'author': _author, 'publisher': _publisher, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'title': _title, 'author': _author, 'publisher': _publisher, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
